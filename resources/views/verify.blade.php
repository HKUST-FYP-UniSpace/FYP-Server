                ...
                <td width="200" valign="top" align="center">
                  <div class="contentEditableContainer contentImageEditable">
                            <div class="contentEditable" align='center' >
                                <img src="http://ec2-18-219-7-135.us-east-2.compute.amazonaws.com/images/AppLogo.png" width="155" height="155"  alt='Logo'  data-default="placeholder" />
                            </div>
                          </div>
                </td>
                <td width="200" valign="top">&nbsp;</td>
                  ...
                  <div class="contentEditableContainer contentTextEditable">
                            <div class="contentEditable" align='left' >
                                <p >Hi {{ $name }},
                                  <br/>
                                  <br/>
                        Thanks for registering on an account with UniSpace. Please enter the following verification into our app before we get started!
                                </p>
                            </div>
                            <div class="contentEditable" align="center">
                                <p id="code">{{ $code }}</p>
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center" width="600" class="container">
              ...
              <tr>
                <td width="60%" height="70" valign="middle" style="padding-bottom:20px;">
                  <div class="contentEditableContainer contentTextEditable">
                        <div class="contentEditable" align='left' >
                            <span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Sent by UniSpace</span>
                      <!-- <br/>
